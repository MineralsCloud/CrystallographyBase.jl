...
@testset "Test creating `Lattice`s from 6 lattice constants" begin
    ...
    @test all(
        latticevectors(Lattice(1, 2, 3, 75, 40, 81; axis=:c)) .≈
    ...
    # Compared with Python's results
    @test all(
        latticevectors(Lattice(3, 4, 20, 45, 90, 126; axis=:c)) .≈ (
    ...
    # Compared with Python's results
    @test all(
        latticevectors(Lattice(1, 2, 3, 90, 115, 90; axis=:c)) .≈
    ...
    # Compared with Python's results
    @test all(
        latticevectors(Lattice(2, 3, 1, 115, 90, 90; axis=:c)) .≈
    ...
    # Compared with Python's results
    @test all(
        latticevectors(Lattice(3, 1, 2, 90, 90, 115; axis=:c)) .≈
    ...
    # Compared with Python's results
    @test all(
        latticevectors(Lattice(2, 2, 3, 90, 90, 120; axis=:c)) .≈
    ...
    # Compared with Python's results
    @test all(
        latticevectors(Lattice(3, 2, 2, 120, 90, 90; axis=:c)) .≈
    ...
    # Compared with Python's results
    @test all(
        latticevectors(Lattice(2, 3, 2, 90, 120, 90; axis=:c)) .≈
    ...
    # Compared with Python's results
    @test all(
        latticevectors(Lattice(2, 2, 2, 90, 120, 90; axis=:c)) .≈
