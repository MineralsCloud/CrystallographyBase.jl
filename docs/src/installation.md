...
[`CrystallographyBase`](https://github.com/MineralsCloud/CrystallographyBase.jl).
...
version of `CrystallographyBase`, type
...
our [GitHub repository](https://github.com/MineralsCloud/CrystallographyBase.jl)
for new releases.
Once we release a new version, you can update `CrystallographyBase` by typing
...
## Uninstall and reinstall `CrystallographyBase`
