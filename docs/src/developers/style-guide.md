...
!!! info
    ...
    follows the rules. When modifying CrystallographyBase, please fix the style violations
...
We use the options contained in [`.JuliaFormatter.toml`](https://github.com/MineralsCloud/CrystallographyBase.jl/blob/main/.JuliaFormatter.toml).
...
!!! info
    A continuous integration check verifies that all PRs made to CrystallographyBase have
