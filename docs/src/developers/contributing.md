...
it is a sign that the [documentation](https://MineralsCloud.github.io/CrystallographyBase.jl/dev/) could be
...
[here](https://github.com/MineralsCloud/CrystallographyBase.jl/tree/main/docs).
...
[here](https://github.com/MineralsCloud/CrystallographyBase.jl/blob/main/.github/ISSUE_TEMPLATE/bug_report.md).

!!! tip
    If you're unsure whether you have a real bug, post on the
    [community forum](https://github.com/MineralsCloud/CrystallographyBase.jl/discussions)
...
The first step is to find an [open issue](https://github.com/MineralsCloud/CrystallographyBase.jl/issues)
...
`~/.julia/dev/CrystallographyBase` unless you modify the
...
Windows, this will be `C:\\Users\\<my_name>\\.julia\\dev\\CrystallographyBase`.
...
Now make any changes to the source code inside the `~/.julia/dev/CrystallographyBase`
directory.
...
```@repl
cd("~/.julia/dev/CrystallographyBase/docs")
using Pkg
Pkg.activate(".")
include("src/make.jl")
```
...
Then go to [https://github.com/MineralsCloud/CrystallographyBase.jl/pulls](https://github.com/MineralsCloud/CrystallographyBase.jl/pulls)
